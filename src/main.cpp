...
int main(void)
{
    ...
    Mesh sphereMesh, headMesh, cubeMesh;
    ...
    Vector3 lightPosition1 = { 5.0f, 5.0f, 0.0f }; //Yellow
    Vector3 lightColor1 = { 2.0f, 2.0f, 0.0f };


    Vector3 lightPosition2 = {-5.0f, 5.0f, 0.0f }; //Red
    Vector3 lightColor2 = { 1.0f, 0.0f, 0.0f };
...
;       }
        ...
        GLint u_lightPosition1 = -2;
        GLint u_lightColor1 = -2;

        GLint u_lightPosition2 = -2;
        GLint u_lightColor2 = -2;
        ...
        case 3:
            ...
            u_lightPosition1 = glGetUniformLocation(shaderProgram, "u_lightPosition1");
            glUniform3fv(u_lightPosition1, 1, &lightPosition1.x);

           
            u_lightColor1 = glGetUniformLocation(shaderProgram, "u_lightColor1");
            glUniform3fv(u_lightColor1, 1, &lightColor1.x);


            u_lightPosition2 = glGetUniformLocation(shaderProgram, "u_lightPosition2");
            glUniform3fv(u_lightPosition2, 1, &lightPosition2.x);


            u_lightColor2 = glGetUniformLocation(shaderProgram, "u_lightColor2");
            glUniform3fv(u_lightColor2, 1, &lightColor2.x);
            ...
            glUseProgram(shaderProgram);
            world = Scale(V3_ONE * lightRadius) * Translate(lightPosition1);
            mvp = world * view * proj;
            //u_world = glGetUniformLocation(shaderProgram, "u_world");
            u_mvp = glGetUniformLocation(shaderProgram, "u_mvp");
            u_color = glGetUniformLocation(shaderProgram, "u_color");
            glUniformMatrix4fv(u_mvp, 1, GL_FALSE, ToFloat16(mvp).v);
            glUniform3fv(u_color, 1, &lightColor1.x);
            ...
            shaderProgram = shaderUniformColor;
            glUseProgram(shaderProgram);
            world = Scale(V3_ONE * lightRadius) *Translate(lightPosition2);
            mvp = world * view * proj;
            //u_world = glGetUniformLocation(shaderProgram, "u_world");
            u_mvp = glGetUniformLocation(shaderProgram, "u_mvp");
            u_color = glGetUniformLocation(shaderProgram, "u_color");
            glUniformMatrix4fv(u_mvp, 1, GL_FALSE, ToFloat16(mvp).v);
            glUniform3fv(u_color, 1, &lightColor2.x);
            glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
            DrawMesh(sphereMesh);
            glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
        ...
        else
        {
            ...
            //step5
            ImGui::SliderFloat3("Light Position 1", &lightPosition1.x, -10.0f, 10.0f);

            ImGui::SliderFloat3("Light Position 2", &lightPosition2.x, -10.0f, 10.0f);
